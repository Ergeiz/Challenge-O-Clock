...
> *je précise au cas où certains voudraient vérifier leur résultat en se basant sur mon truc, ma méthode pour que sudo ne demande pas de password n'est pas bonne (de cette manière tout le monde peut se co à cette user), mais après avoir parler de respecter les bonnes pratiques je la trouvais marrante.*
